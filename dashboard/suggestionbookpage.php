    ...
    <body>
        ...
        <script>
            ...
            if (urlParams.has('success')) {
                ...
                verifContainer.style.visibility = 'visible';
                verifContainer.style.display = 'flex';
                ...
                // Fade out the verification container after 3 seconds
                setTimeout(function() {
                    request.classList.remove('show'); // Remove 'show' class to trigger fade-out
                }, 1500); // Wait 3 seconds before fading out
            }
